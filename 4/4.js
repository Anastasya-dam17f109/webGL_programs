...
const Data = {
    ...
    c1_t: function (t, pt) {
        ...
        pt.y = 0;
        pt.z = this.Z * Math.cos(this.Xmin + t * (this.Xmax - this.Xmin) - this.Xmid) * Math.sin(this.Ymin - this.Ymid)*(this.Xmax - this.Xmin);
    },
    c2: function (t, pt) {
        pt.x = this.Xmin + t * (this.Xmax - this.Xmin) - this.Xmid;
    ...
    c2_t: function (t, pt) {
        ...
        pt.x = (this.Xmax - this.Xmin);
        pt.y = 0;
        pt.z = this.Z * Math.cos( this.Xmin + t * (this.Xmax - this.Xmin) - this.Xmid) * Math.sin(this.Ymax - this.Ymid)*(this.Xmax - this.Xmin);
    },
    ...
    calculateRuledSurface: function(){
        ...
        for (i = 0; i < N; i++) {
           ...
           for (j = 0; j < M; j++) {
               ...
               const x_tau = -pt1.x+ pt2.x;
               const y_tau = -pt1.y+ pt2.y ;
               const z_tau = -pt1.z+ pt2.z;
