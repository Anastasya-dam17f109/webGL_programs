...
function main() {
    ...
    Data.init(gl, countSplinePoints, equallySpaced, chordLength, centripetalMethod);
...
const Data = {
    ...
    init: function (gl, countSplinePoints, equallySpaced, chordLength, centripetalMethod) {
        this.gl = gl;
    ...
    calculateLineSpline: function () {
        ...
        let pt;
        let t, x, y, dt, omega;
		let n = this.pointsCtr.length-1
		let d = 0
        // –¿——◊»“¿“‹ «Õ¿◊≈Õ»≈ œ¿–¿Ã≈“–»◊≈— »’  ŒŒ–ƒ»Õ¿“  ŒÕ“–ŒÀ‹Õ€’ “Œ◊≈ 
		for(i = 1; i< this.pointsCtr.length; i++)
		{
			if (this.centripetalMethod.checked)
			d+= Math.sqrt(Math.sqrt( (this.pointsCtr[i].x - this.pointsCtr[i-1].x)*(this.pointsCtr[i].x - this.pointsCtr[i-1].x)+(this.pointsCtr[i].y - this.pointsCtr[i-1].y)*(this.pointsCtr[i].y - this.pointsCtr[i-1].y)) )
			else
				if(this.chordLength.checked)
					d+=Math.sqrt((this.pointsCtr[i].x - this.pointsCtr[i-1].x)*(this.pointsCtr[i].x - this.pointsCtr[i-1].x)+(this.pointsCtr[i].y - this.pointsCtr[i-1].y)*(this.pointsCtr[i].y - this.pointsCtr[i-1].y))
		}
		...
		for(i = 0; i< this.pointsCtr.length; i++)
		{
			...
			if (this.centripetalMethod.checked)
				if (i ==0)
					...
					this.pointsCtr[i].t = this.pointsCtr[i-1].t + Math.sqrt(Math.sqrt( (this.pointsCtr[i].x - this.pointsCtr[i-1].x)*(this.pointsCtr[i].x - this.pointsCtr[i-1].x)+(this.pointsCtr[i].y - this.pointsCtr[i-1].y)*(this.pointsCtr[i].y - this.pointsCtr[i-1].y)))/d  ;
			if (this.chordLength.checked)
				if (i ==0)
					this.pointsCtr[i].t = 0
				else
					this.pointsCtr[i].t = this.pointsCtr[i-1].t + Math.sqrt((this.pointsCtr[i].x - this.pointsCtr[i-1].x)*(this.pointsCtr[i].x - this.pointsCtr[i-1].x)+(this.pointsCtr[i].y - this.pointsCtr[i-1].y)*(this.pointsCtr[i].y - this.pointsCtr[i-1].y))/d  ;
